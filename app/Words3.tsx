...
export default function Words3() {
  ...
  return <ImageBackground style={styles.background}>
    ...
    <View style={styles.container}>
      ...
      <View style={styles.contentContainer}><View style={styles.imageStage}><View style={styles.imageAccent} /><View style={styles.imageAccentSmall} /><Image source={current.image} style={styles.image} resizeMode="contain" /></View>
