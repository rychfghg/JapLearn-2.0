...
const missions = [
  { title: 'Ahiru Rescue', subtitle: 'Stop the Cage Drop', description: 'Choose natural Japanese before the pirate lowers Ahiru’s cage into the sea.', objective: 'Keep the rescue rope secured', difficulty: 'RESCUE', route: '/QuackSituateRecognition', icon: 'lock-closed-outline', action: 'CAGE RESCUE', color: '#65A936', tint: '#EAF5E3', character: '救', image: require('../assets/quacksituate/pirate-rescue/cage-drop-menu-cover.png') },
  { title: 'Expression Match', subtitle: 'Move the phrase to the gesture', description: 'Read the moment, listen, and match natural Japanese to Ahiru’s gesture.', objective: 'Match every gesture and phrase', difficulty: 'GESTURE TRAIL', route: '/QuackSituateMatchingLevels', icon: 'hand-left-outline', action: 'GESTURE MATCH', color: '#7652E8', tint: '#EEE8FF', character: '会', image: require('../assets/quacksituate/cards/expression-match-gesture-cover.png') },
