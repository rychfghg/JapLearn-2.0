...
type StageActivity = { key: string; label: string; value: number; sessions: number };
type Stage = { id?: number; name: string; progress: number; status: string; unlocked: boolean; activities?: StageActivity[] };
