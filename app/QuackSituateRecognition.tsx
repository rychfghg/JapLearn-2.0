...
export default function QuackSituateRecognition() {
  ...
  if (isExiting) return <AhiruMissionExit color="#65A936" tint="#EAF5E3" icon="eye-outline" eyebrow="RECOGNITION SAVED" title="Mission complete" message="Your situational greeting score is now available in QuackProgress and the teacher performance record." footer="Notice the person, place, and time before choosing your words." mascot={require('../assets/hello.png')} onComplete={() => router.replace({ pathname: '/QuackSituate', params: { skipLoading: '1' } })} />;
