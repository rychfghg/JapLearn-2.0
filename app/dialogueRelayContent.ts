...
export const RELAY_SCENES: RelayScene[] = [
  {
    ...
    sumi: 'このびんは、今日出してもいいですか？', haru: '看板には「燃えるごみ」と書いてあります。',
    questions: [
  ...
  },
  {
    ...
    sumi: '不在票がありますね。再配達をお願いできます。', haru: '電話で何と言えばいいでしょうか？',
    questions: [
  ...
  },
  {
    ...
    sumi: '受付では、症状を短く伝えましょう。', haru: '昨日から、のどが痛いです。',
    questions: [
  ...
  },
  {
    ...
    sumi: '薬の飲み方を確認しましょう。', haru: '食後ですか、食前ですか？',
    questions: [
  ...
  },
  {
    ...
    sumi: 'まず、体を洗ってから入りましょう。', haru: 'タオルは湯船に入れませんね。',
    questions: [
  ...
  },
  {
    ...
    sumi: 'ここで靴を脱ぎます。', haru: '畳の部屋では、スリッパも脱ぎますね。',
    questions: [
  ...
  },
  {
    ...
    sumi: '写真を撮る前に、聞きましょう。', haru: '人の顔も写りますね。',
    questions: [
  ...
  },
  {
    ...
    sumi: '注文する前に、アレルギーを伝えましょう。', haru: '私はえびが食べられません。',
    questions: [
  ...
  },
  {
    ...
    sumi: '交番で、落とし物について相談できます。', haru: '黒い財布をなくしました。',
    questions: [
  ...
  },
  {
    ...
    sumi: 'まず、頭を守ってください。', haru: '揺れが止まるまで、ここにいます。',
    questions: [
