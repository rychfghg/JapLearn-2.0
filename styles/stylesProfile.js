...
export const styles = StyleSheet.create({
    ...
    deleteModalIcon: { backgroundColor: '#FCEBED' },
    deleteSupportButton: {
        flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8,
        width: '100%', paddingVertical: 13, borderRadius: 14,
        backgroundColor: '#F5ECFC', borderWidth: 1, borderColor: '#E7D6F6',
    },
    deleteSupportText: { color: '#7A2CC4', fontSize: 13, fontWeight: '700' },
    deleteWarningBox: {
        width: '100%', marginTop: 14, padding: 14, borderRadius: 15,
        backgroundColor: '#FDF3F4', borderWidth: 1, borderColor: '#F3DADE',
    },
    deleteWarningTitle: { color: '#B73540', fontSize: 13, fontWeight: '800' },
    deleteWarningText: { color: '#8A6B70', fontSize: 12, lineHeight: 18, marginTop: 5 },
    deleteCheckRow: { flexDirection: 'row', alignItems: 'flex-start', gap: 10, width: '100%', marginTop: 15 },
    deleteCheckbox: {
        width: 23, height: 23, borderRadius: 7, borderWidth: 2, borderColor: '#C9BCD0',
        alignItems: 'center', justifyContent: 'center', marginTop: 1,
    },
    deleteCheckboxOn: { backgroundColor: '#C53D47', borderColor: '#C53D47' },
    deleteCheckText: { flex: 1, color: '#5F5166', fontSize: 12.5, lineHeight: 18 },
    deleteErrorText: { width: '100%', color: '#C53D47', fontSize: 12, fontWeight: '700', marginTop: 12 },
    deleteActions: { flexDirection: 'row', gap: 10, width: '100%', marginTop: 18 },
    deleteCancelButton: {
        flex: 1, height: 50, borderRadius: 15, alignItems: 'center', justifyContent: 'center',
        backgroundColor: '#F4EFF6', borderWidth: 1, borderColor: '#E4DBE8',
    },
    deleteCancelText: { color: '#5F5166', fontSize: 14, fontWeight: '800' },
    deleteContinueButton: {
        flex: 1, height: 50, borderRadius: 15, alignItems: 'center', justifyContent: 'center',
        backgroundColor: '#8423D9',
    },
    deleteContinueText: { color: '#FFFFFF', fontSize: 14, fontWeight: '800' },
    deleteConfirmButton: {
        flex: 1, height: 50, borderRadius: 15, alignItems: 'center', justifyContent: 'center',
        backgroundColor: '#C53D47',
    },
    deleteConfirmText: { color: '#FFFFFF', fontSize: 14, fontWeight: '800' },
    deleteButtonDisabled: { opacity: 0.45 },
    deleteWordHint: { color: '#B73540', fontWeight: '800' },
    deleteInput: {
        width: '100%', height: 52, borderRadius: 14, paddingHorizontal: 15,
        borderWidth: 1.5, borderColor: '#E4DBE8', backgroundColor: '#FBF8FC',
        color: '#3F2C49', fontSize: 15, fontWeight: '700', letterSpacing: 1.5,
    },
