...
export default StyleSheet.create({
  ...
  background: { flex: 1 },
  overlay: { ...StyleSheet.absoluteFillObject, backgroundColor: 'rgba(249,245,251,0.82)' },
  header: {
    margin: 16,
    marginBottom: 10,
    padding: 12,
  ...
  headerIcon: { width: 40, height: 40, marginLeft: 10, borderRadius: 14, backgroundColor: '#F1E7F9', alignItems: 'center', justifyContent: 'center' },
  headerCopy: { flex: 1, marginLeft: 9, marginRight: 8 },
  ...
  coachCard: { minHeight: 138, paddingHorizontal: 17, paddingTop: 13, borderRadius: 28, backgroundColor: 'rgba(241,229,250,0.96)', borderWidth: 1, borderColor: '#E5D3F2', flexDirection: 'row', alignItems: 'center', overflow: 'hidden' },
  sumi: { width: 108, height: 132, alignSelf: 'flex-end' },
  coachCopy: { flex: 1, marginLeft: 10 },
  coachKicker: { fontFamily: 'Jua', fontSize: 9, letterSpacing: 1.1, color: '#8051C8' },
  coachTitle: { marginTop: 5, fontFamily: 'Jua', fontSize: 19, lineHeight: 24, color: '#3E244C' },
  coachText: { marginTop: 6, fontSize: 12, lineHeight: 18, color: '#746A79' },
  tabs: { marginTop: 13, padding: 5, borderRadius: 19, backgroundColor: 'rgba(255,255,255,0.96)', borderWidth: 1, borderColor: '#ECE4EF', flexDirection: 'row' },
  ...
  statusCard: { marginTop: 14, padding: 17, borderRadius: 24, backgroundColor: 'rgba(255,255,255,0.97)', borderWidth: 1, borderColor: '#EEE6F1', flexDirection: 'row' },
