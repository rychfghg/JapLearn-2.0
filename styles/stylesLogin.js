...
const styles = StyleSheet.create({
  ...
  scrollContent: {
    ...
    paddingTop: Platform.OS === 'web' ? 38 : 24,
    paddingBottom: 28,
  },
  authShell: { width:'100%', maxWidth:430, alignSelf:'center' },
  ...
  formCard: {
    backgroundColor: '#FFFDFF', borderRadius: 28, paddingHorizontal: 23, paddingVertical: 25,
  ...
  cardHeading: { alignItems: 'center', marginBottom: 24 },
  cardHeadingMark: { width: 38, height: 5, borderRadius: 99, backgroundColor: '#8ED94D', marginBottom: 12 },
  formTitle: { fontFamily:'Jua',fontSize: 28, color: '#3B2446' },
  ...
  inputContainer: {
    flexDirection: 'row', alignItems: 'center', backgroundColor: '#F9F6FB',
    borderWidth: 1.5, borderColor: '#E2D6E8', borderRadius: 16, paddingHorizontal: 15,
    marginBottom: 14,
  },
